...
#include <iostream>
struct MyVec {
  int* data; // a pointer to the beginning of your array of ints
  int capacity; // the "capacity" of the vector,
  int size; //the "size" of the vector.
};

//The "capacity" is the actual length of the array you created, and the "size" is the number of ints currently being stored.
MyVec makeVector(int initialCapacity) { // 为什么在一个vector 里面creat 另一个vector？
